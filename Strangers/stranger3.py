...
class Stranger:
    ...
    def __init__(self, game):
        ...
        self.person_text1 = Text('THE TOWN RESIDENT:',650 ,130, 25, WHITE)
        self.person_text2 = Text('Some folks think that they can get to buffalo in a single shot from New York,',650 ,230, 23, WHITE)
        self.person_text3 = Text('Its dangerous. Better take it slow.',650 ,330, 23, WHITE)
